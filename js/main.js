...
document.getElementById("menu-click").addEventListener("click", function (e) {
    e.preventDefault();
    //Mostrar y ocultar el menu del navbar
    var links = document.getElementById("nav-links");

    if (links.style.display == "none") { //Si el menu esta oculto
        links.style.display = "flex"; //Mostrar el menu
        //animacion de entrada
        links.style.animation = "scrollAnimation ease-in-out 0.5s";
        //animacion de salida
    } else {
        //Ocultar y animar el menu
        links.style.animation = "animate__fadeOutLeft ease-in-out 0.5s";
        //Ocultar el menu
        setTimeout(function () {
